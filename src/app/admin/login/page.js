...
export default function AdminLoginPage() {
  ...
  // ✅ Already admin → hard redirect to dashboard
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result?.ok) {
        ...
        // ✅ HARD navigation — full reload so session is fresh
        setTimeout(() => {
          window.location.href = '/admin/dashboard';
        }, 500);
      }
  ...
  // ── Already admin — show redirect spinner ──
  if (status === 'authenticated' && session?.user?.role === 'admin') {
    return (
      <div style={{
        minHeight: '100vh',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
            ...
            <div>
              ...
              <div style={{
                ...
                <input
                  ...
                  placeholder="admin@Arunas Baby World.com"
                  required
                  style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '20px' }}>
            <Link href="/" style={{
              ...
              textDecoration: 'none',
            }}>← Back to Arunas Baby World Store</Link>
          </div>
        ...
        <p style={{
          ...
          fontWeight: '500',
        }}>© 2024 Arunas Baby World Admin Portal. All rights reserved.</p>
